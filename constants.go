...
const (
	...
	BUTTON_TEXT_SKIP_INTRO        = EMOJI_BUTTON_START + "Пропустите введение" + EMOJI_BUTTON_END
	BUTTON_TEXT_BALANCE           = EMOJI_BUTTON_START + "Текущий баланс" + EMOJI_BUTTON_END
	BUTTON_TEXT_USEFUL_ACTIVITIES = EMOJI_BUTTON_START + "Полезные виды деятельности" + EMOJI_BUTTON_END
